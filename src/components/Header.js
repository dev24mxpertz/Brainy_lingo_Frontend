  ...
  return (
    <div className="Stories-header">
      <div className="stories-header-left">
        ...
        <button  className="button-header-1">
          Leader Board
        </button>
        <div className="headline-arraow">
          <div className="arrow_div">
        ...
        <button className="button-header-1">Daily Quiz</button>
        <div className="headline-arraow">
          <div className="arrow_div">
            <i className="bi bi-chevron-right"></i>
          </div>
      ...
      {BigResponsiveHeader ? (
        <div className="stories-header-left_4 visible">
          ...
          <button className="button-header-4">Leader Board</button>
          <button className="button-header-4">Daily Quiz</button>
